...
parser = argparse.ArgumentParser(description="用于将文件同步到百度网盘中指定路径中去")
parser.add_argument("-i", "--infile", type=str, help="./MED/allsamples/,最好写绝对路径", required=True)
parser.add_argument("-n", "--dirname", type=str, help="200215_NB501129_0525_AHWLYNAFXY", required=True)
